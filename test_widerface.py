...
parser.add_argument('-m', '--trained_model', default='/home/jiangcc/jcc/Pytorch_master2/Pytorch_Retinaface-master/model/0305/0305mobilenet0.25_Final.pth',
                    type=str, help='Trained state_dict file path to open')
...
parser.add_argument('--save_folder', default='./result/text/', type=str, help='Dir to save txt results')  # 测试训练集的精确度看是否过拟合，对比文件0614
...
#     path='/home/jiangcc/jcc/Pytorch_master2/Pytorch_Retinaface-master/model/0310_2_mobilev2/mobilenet0.25_Final.pth'
   ...
   # testset_list = args.dataset_folder[:-7] + "image_label.txt"  
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        # image_path = 'D:\\F\\0621\\Pytorch_Retinaface_maste\\Pytorch_Retinaface-master\\data\widerface\\train\images\\20--Family_Group\\20_Family_Group_Family_Group_20_43.jpg'
        image_path = './result/image/famile.jpg'
...
#             cv2.imwrite(name, img_raw)
            ...
            if not os.path.exists("./result/image/"):
                os.makedirs("./result/image/")
            # name = "./result/image/" + str(i) + ".jpg"
            name = "./result/image/" + str(3) + ".jpg"
            cv2.imwrite(name, img_raw)
